package ru.practicum.api.controller.admin;
...
public class AdminCompilationController {
    ...
    public CompilationFullDto create(
            @RequestBody @Validated(CreateValidation.class) CompilationUpdateDto dto) {
    ...
    public CompilationFullDto update(
            ...
            @RequestBody @Validated(UpdateValidation.class) CompilationUpdateDto dto) {

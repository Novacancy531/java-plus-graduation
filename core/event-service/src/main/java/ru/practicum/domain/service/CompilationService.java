...
public class CompilationService {
    ...
    @Transactional
    public CompilationFullDto create(CompilationUpdateDto dto) {
    ...
    @Transactional
    public CompilationFullDto update(Long compId, CompilationUpdateDto dto) {
    ...
    public List<CompilationFullDto> find(Boolean pinned, int from, int size) {
        int pageNumber = from / size; // 0-based
        Pageable pageable = PageRequest.of(pageNumber, size);

        var resultPage = (pinned != null)
